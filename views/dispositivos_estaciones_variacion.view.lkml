# The name of this view in Looker is "Dispositivos Estaciones Variacion"
view: dispositivos_estaciones_variacion {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `transmilenio.Dispositivos_estaciones_variacion` ;;
